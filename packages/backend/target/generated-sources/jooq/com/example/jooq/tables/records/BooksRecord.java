...
public class BooksRecord extends UpdatableRecordImpl<BooksRecord> {
    ...
    /**
     * Setter for <code>public.books.ilid</code>.
     */
    ...
    /**
     * Getter for <code>public.books.ilid</code>.
     */
     ...
     */
    public BooksRecord(Integer id, String title, String author, String isbn, String ilid, LocalDate started, LocalDate finished) {
        super(Books.BOOKS);
